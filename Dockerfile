...
ARG HALO_VERSION
RUN apk add --no-cache tini tzdata && cp /usr/share/zoneinfo/Asia/Shanghai /etc/localtime && echo Asia/Shanghai > /etc/timezone
 && apk del tzdata && addgroup -S -g 1000 halo && adduser -S -D -u 1000 -h /home/halo -s /bin/sh -G halo halo
